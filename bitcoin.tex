...
\begin{figure*}[h]
    ...
    \caption{Bitcoin: visión general. cite{rexford}.}
...
\begin{figure}[h]
    ...
    \caption{Transacción Bitcoin vista como un libro de contabilidad. cite{rexford}.}
...
\begin{figure}[h]
    ...
    \caption{Una cadena de transacciones, donde la salida de una transacción es la entrada de la otra. cite{rexford}.}
    \label{fig:chain}
\end{figure}
